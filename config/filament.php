...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | This configuration option allows you to customize the layout
    | of the Filament admin panel, including
    | the behavior of the sidebar.
    |------------------------------------------------------------------------
    */
    ...
    'layout' => [
        'sidebar' => [
            ...
            'is_collapsed_by_default_on_desktop' => true,
        ]
    ]
];
